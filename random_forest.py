...
"""
Using the random forest algorithm to calculate the importance of 24 features.
"""

filename = 'raw_data/raw_meteorological_data.csv'
...
print('Results of feature importance ranking:')
